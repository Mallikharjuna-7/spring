			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="email">E-mail</label> <input type="email" id="email"
						name="email" value="${updateResult.email }" onchange="checkEmail(); " readonly> <br>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="aadhar">Aadhar Number</label> <input type="tel"
						id="aadhar" name="aadhar" value="${updateResult.aadhar }" onchange="checkAadharNumber()" readonly><br>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="country">Country</label> <input type="text"
						id="country" name="country" value="India" value="${updateResult.country }" readonly>
				</div>
			</div>
