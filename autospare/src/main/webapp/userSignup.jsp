...
<body>
			...
			<div class="form-row">
				...
				<div class="input-group">
					<label for="country">Country</label> <input type="text"
						id="country" name="country" value="India" readonly>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		function checkEmailDuplicate() {
			...
			console.log(req);
			req.open("GET", "http://localhost:8080/autospare/getMail?email="+userEmail);
			req.send();
			req.onload = function() {
		...
		function checkAadharDuplicate(){
			...
			const req = new XMLHttpRequest();
			console.log(req);
			req.open("GET", "http://localhost:8080/autospare/getAadhar?aadhar="+userAadhar);
			req.send();
			req.onload = function() {
				console.log(req.responseText);
		...
		function checkContactDuplicate(){
			...
			const req = new XMLHttpRequest();
			console.log(req);
			req.open("GET", "http://localhost:8080/autospare/getContact?contact="+userContact);
			req.send();
			req.onload = function() {
				console.log(req.responseText);
